...
update_cache() {
	exclude_search=".cache\|sublime_text_3\|sublime-text-3\|chromium\|.icons\|.themes\|.pgadmin\|node_modules\|venv\|busybox\|buildroot\|generated_completions\|scrollback\|.dbus\|.fonts\|.vscode\|Code"
...
ssh=$(echo -e "ssh: marlon@192.168.25.2")
#drun=$(cat ~/.config/dmenu_drun)
drun=$(echo -e "drun: chromium\ndrun: st\ndrun: pcmanfm\ndrun: gcolor2\ndrun: transmission-gtk\ndrun: sublime_text\ndrun: lxappearance\ndrun: hexchat\ndrun: steam")
